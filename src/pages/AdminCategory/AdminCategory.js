...
export default function AdminCategory() {
  ...
  const [text, setText] = useState("Thêm mới loại");
    ...
    if (product.description) {
      ...
      if (product.product_id !== "0") {
        ...
        toast.current.show({
          severity: "success",
          summary: "Thành công",
          detail: `Cập nhật loại ${product.name} thành công`,
          life: 8000,
          options: {
            className: 'custom-margin-class',
          },
        });
        setText("Chỉnh sửa loại");
      } else {
        console.log(_product);
        ...
        toast.current.show({
          severity: "success",
          summary: "Thành công",
          detail: "Tạo  mới loại thành công",
          life: 3000,
        });
        setProductDialog(false);
      }
  ...
  const deleteProduct = async () => {
    ...
    toast.current.show({
      severity: "error",
      summary: "Thành công",
      detail: `Xóa loại ${product.name} thành công`,
      life: 3000,
      options: {
        style: {
          zIndex: 100,
      ...
      <div>
        ...
        <div className="card">
          ...
          <DataTable
            ...
            currentPageReportTemplate="Đang hiển thị {first} đến {last} trong tổng số {totalRecords} loại"
        ...
        >
          <div className="confirmation-content" style={{margin:'20px 20px'}}>
            ...
            {product && (
              <span>
                Bạn có chắc chắn muốn xóa loại <b>{product.name}</b>?
              </span>
            )}
          </div>
        </Dialog>
